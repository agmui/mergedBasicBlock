...
#ifndef LLVM_MERGED_TREE_FUNCTIONCOMPARATOR_CP_H
#define LLVM_MERGED_TREE_FUNCTIONCOMPARATOR_CP_H
...
/// side of claiming that two functions are different).
    class FunctionComparator_cp {
    public:
        FunctionComparator_cp(const Function *F1, const Function *F2,
...
#endif //LLVM_MERGED_TREE_FUNCTIONCOMPARATOR_CP_H
